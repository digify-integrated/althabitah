...
<html class="no-js" lang="en">
    ...
    <body data-mobile-nav-style="classic">
        ...
        <!-- start page title -->
        <section class="top-space-margin page-title-big-typography cover-background pt-0 pb-0" style="background-image: url(./assets/images/services/house-cleaning-01.jpg)">
            <div class="container">
                <div class="row align-items-center justify-content-center small-screen">
                    <div class="col-xl-5 col-sm-8 page-title-double-large text-center" data-anime='{ "el": "childs", "opacity": [0, 1], "translateY": [30, 0], "duration": 600, "staggervalue": 300, "easing": "easeOutQuad" }'>
                        <h1 class="text-base-color fw-700 mb-5px">House Cleaning</h1>
                        <h2 class="text-white fw-600 ls-1px mb-0 text-uppercase">Keep your home spotless with thorough cleaning tailored to your needs</h2>
                    </div>
                </div>
            </div>
        </section>
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-lg-8 order-1 order-lg-2 md-mb-50px" data-anime='{ "el": "childs", "translateY": [50, 0], "opacity": [0,1], "duration": 1200, "delay": 0, "staggervalue": 150, "easing": "easeOutQuad" }'>
                        ...
                        <p>Welcome to AL THABITAH's House Cleaning Service, where we turn your house into a spotless sanctuary. Our expert team specializes in providing comprehensive cleaning solutions tailored to meet your unique needs. From routine maintenance to deep cleaning, we handle it all with meticulous attention to detail and professionalism. Using advanced equipment and eco-friendly products, we ensure a thorough clean that leaves every corner of your home sparkling. Sit back, relax, and let us take care of the dirty work, so you can enjoy a clean and comfortable living space. Experience the difference with AL THABITAH's House Cleaning Service today.</p>
                        <div class="cover-background p-7 border-radius-6px mb-60px md-mb-40px d-flex justify-content-end align-items-end sm-h-500px" style="background-image: url(./assets/images/services/house-cleaning-02.jpg)">
                        ...
                        <div class="border border-color-extra-medium-gray border-radius-6px mb-40px xs-mb-30px overflow-hidden">
                            <p class="p-30px border-bottom border-1 border-color-extra-medium-gray mb-0"><span class="fw-600 text-dark-gray">Spotless Living: </span>Experience a fresh and clean home with meticulous attention to detail.
                            </p>
                            ...
                            <p class="p-30px mb-0"><span class="fw-600 text-dark-gray">Healthier Home: </span>Remove dust, allergens, and germs for a healthier living environment.</p>
