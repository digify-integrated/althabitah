...
<html class="no-js" lang="en">
    ...
    <body data-mobile-nav-style="classic">
        ...
        <!-- start page title -->
        <section class="top-space-margin page-title-big-typography cover-background pt-0 pb-0" style="background-image: url(./assets/images/services/office-cleaning-01.jpg)">
            <div class="container">
                <div class="row align-items-center justify-content-center small-screen">
                    <div class="col-xl-5 col-sm-8 page-title-double-large text-center" data-anime='{ "el": "childs", "opacity": [0, 1], "translateY": [30, 0], "duration": 600, "staggervalue": 300, "easing": "easeOutQuad" }'>
                        <h1 class="text-base-color fw-700 mb-5px">Office Cleaning</h1>
                        <h2 class="text-white fw-600 ls-1px mb-0 text-uppercase">Ensure a clean and productive workspace with our reliable office cleaning services</h2>
                    </div>
                </div>
            </div>
        </section>
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-lg-8 order-1 order-lg-2 md-mb-50px" data-anime='{ "el": "childs", "translateY": [50, 0], "opacity": [0,1], "duration": 1200, "delay": 0, "staggervalue": 150, "easing": "easeOutQuad" }'>
                        ...
                        <p>Transform your workplace into a shining beacon of professionalism with AL THABITAH's Office Cleaning Service. Our dedicated team understands the importance of a clean and orderly workspace for productivity and employee well-being. With our meticulous attention to detail and efficient cleaning techniques, we ensure every corner of your office is spotless and inviting. From disinfecting high-touch surfaces to vacuuming carpets and polishing surfaces, we handle it all with expertise and care. Experience the difference with AL THABITAH's Office Cleaning Service and enjoy a cleaner, healthier, and more productive work environment.</p>
                        <div class="cover-background p-7 border-radius-6px mb-60px md-mb-40px d-flex justify-content-end align-items-end sm-h-500px" style="background-image: url(./assets/images/services/office-cleaning-02.jpg)">
                        ...
                        <div class="border border-color-extra-medium-gray border-radius-6px mb-40px xs-mb-30px overflow-hidden">
                            <p class="p-30px border-bottom border-1 border-color-extra-medium-gray mb-0"><span class="fw-600 text-dark-gray">Productivity Boost: </span>A clean office promotes a focused and efficient work environment.
                            </p>
                            ...
                            <p class="p-30px mb-0"><span class="fw-600 text-dark-gray">Custom Schedules: </span>Flexible cleaning plans tailored to fit your business needs.</p>
